...
const Footer = () => {
  return (
    <div className="footer" id="contact-nav">
      <div>
        <div className="footer-logo">
          <strong>Career</strong>Navigator <i className="fab fa-typo3"></i>
        </div><br /><br />
        <p className="p-div">
          We always make our seekers and companies<br />find the best jobs and
      ...
      <div className="left-side">
        ...
        <div className="infos">
          <small className="email">murukesh@gmail.com</small>
          <div className="icons">
